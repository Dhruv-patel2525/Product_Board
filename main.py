...
from app.api.v1.products import router as prod_router
from app.api.v1.feedback import router as feed_router
from app.api.v1.comments import router as comm_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(prod_router,prefix="/api/v1")
